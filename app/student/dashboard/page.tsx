...
const stats = [
  ...
  { label: "Quiz complétés", value: "24", icon: CheckCircle, color: "text-accent", bg: "bg-accent/10" },
  { label: "Heures d'étude", value: "48h", icon: Clock, color: "text-chart-3", bg: "bg-chart-3/10" },
...
const currentCourses = [
  ...
  },
  {
    ...
    progress: 45,
    nextLesson: "Optimisation des requêtes",
  ...
  },
  {
    ...
    progress: 32,
    nextLesson: "Protocoles de sécurité",
    image: "bg-gradient-to-br from-chart-3/20 to-chart-3/5",
  },
]

const upcomingTasks = [
  { id: 1, title: "Devoir: API REST", course: "Développement Web", due: "2 jours", type: "assignment" },
  { id: 2, title: "Quiz: SQL avancé", course: "Base de données", due: "3 jours", type: "quiz" },
  { id: 3, title: "Projet final", course: "Réseaux", due: "1 semaine", type: "project" },
]

const notifications = [
  { id: 1, message: "Nouveau cours disponible: Machine Learning", time: "Il y a 2h" },
  { id: 2, message: "Quiz corrigé: JavaScript Basics - 18/20", time: "Il y a 5h" },
  { id: 3, message: "Rappel: Devoir à rendre demain", time: "Il y a 1j" },
]
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-sidebar-foreground/60">5h d&apos;étude par semaine</p>
                </div>
              </div>
