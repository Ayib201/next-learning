        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed text-pretty">
              {"Accedez a des cours de qualite, des quiz interactifs et un suivi personnalise de votre progression. Rejoignez notre communaute d'apprenants et d'enseignants."}
            </p>
              ...
              <div className="rounded-xl bg-sidebar p-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-sidebar-foreground/60">Niveau: Avance</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {["Developpement Web", "Base de donnees", "Reseaux"].map((course, i) => (
            ...
            <div className="absolute -right-4 -top-4 rounded-xl border border-border bg-card p-3 shadow-lg">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">React Avance</p>
                </div>
              </div>
            </div>
