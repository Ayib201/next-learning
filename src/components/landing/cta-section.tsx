          ...
          <div className="relative grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              <h2 className="text-3xl font-bold text-sidebar-foreground sm:text-4xl text-balance">
                {"Pret a commencer votre parcours d'apprentissage?"}
              </h2>
              <p className="mt-4 text-lg text-sidebar-foreground/70 text-pretty">
                {"Rejoignez des milliers d'etudiants qui ont deja transforme leur carriere grace a ISI E-Learning."}
              </p>
